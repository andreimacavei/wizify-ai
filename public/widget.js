let BASE_URL="http://localhost:3000/api/enhance";function emToPixels(l,n){n=n||document.documentElement;var c=getComputedStyle(n).fontSize;c||(c=getComputedStyle(document.documentElement).fontSize);var e=parseFloat(c),a=l*e;return a}function copyStyles(l,n){const c=window.getComputedStyle(l);for(let e=0;e<c.length;e++){const a=c[e];a=="width"&&(n.style[a]=c.getPropertyValue(a))}n.style.width=l.offsetWidth+"px",n.style.height=l.offsetHeight+"px"}document.addEventListener("DOMContentLoaded",function(){var l=document.createElement("style");l.innerHTML=`
    .micro-ai {
        position: absolute;
        right: 3px;
        z-index: 10;

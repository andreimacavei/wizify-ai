let BASE_URL="https://app.wizzardai.dev/api/enhance",CLIENT_KEY=extractClientId(document.currentScript.getAttribute("src"))||"";function extractClientId(e){const a=/client_key=([^&]*)/,t=e.match(a);return t?t[1]:null}function emToPixels(e,a){a=a||document.documentElement;var t=getComputedStyle(a).fontSize;t||(t=getComputedStyle(document.documentElement).fontSize);var i=parseFloat(t),r=e*i;return r}function copyStyles(e,a){const t=window.getComputedStyle(e);for(let i=0;i<t.length;i++){const r=t[i];r=="width"&&(a.style[r]=t.getPropertyValue(r))}a.style.width=e.offsetWidth+"px",a.style.height=e.offsetHeight+"px"}function loadStyle(){var e=document.createElement("style");e.innerHTML=`
    .micro-ai {
        position: absolute;
        right: 3px;
        z-index: 10;

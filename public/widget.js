let BASE_URL="https://micro-ai-mage.vercel.app/api/enhance";function emToPixels(l,o){o=o||document.documentElement;var i=getComputedStyle(o).fontSize;i||(i=getComputedStyle(document.documentElement).fontSize);var e=parseFloat(i),a=l*e;return a}function copyStyles(l,o){const i=window.getComputedStyle(l);for(let e=0;e<i.length;e++){const a=i[e];a=="width"&&(o.style[a]=i.getPropertyValue(a))}o.style.width=l.offsetWidth+"px",o.style.height=l.offsetHeight+"px"}document.addEventListener("DOMContentLoaded",function(){var l=document.createElement("style");l.innerHTML=`
    .micro-ai {
        position: absolute;
        right: 3px;
        z-index: 10;

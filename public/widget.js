let BASE_URL="https://app.wizzardai.dev/api/enhance",CLIENT_KEY=extractClientId(document.currentScript.getAttribute("src"))||"";function extractClientId(e){const o=/client_key=([^&]*)/,t=e.match(o);return t?t[1]:null}function emToPixels(e,o){o=o||document.documentElement;var t=getComputedStyle(o).fontSize;t||(t=getComputedStyle(document.documentElement).fontSize);var n=parseFloat(t),a=e*n;return a}function copyStyles(e,o){const t=window.getComputedStyle(e);for(let n=0;n<t.length;n++){const a=t[n];a=="width"&&(o.style[a]=t.getPropertyValue(a))}o.style.width=e.offsetWidth+"px",o.style.height=e.offsetHeight+"px"}function createToolbar(){const e=`<svg fill="#000000" height="16px" width="16px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
   ...
   c0,100.286,81.588,181.874,181.874,181.874s181.874-81.588,181.874-181.874C365.442,150.223,355.453,116.201,336.554,86.871z"/></svg>`,o=`<svg fill="#000000" height="16px" width="16px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
    ...
    </g></svg>`,t=document.createElement("button");t.innerHTML=e,t.className="toolbar-undo-button",t.type="button";const n=document.createElement("button");n.innerHTML=o,n.className="toolbar-redo-button",n.type="button";const a=document.createElement("div");return a.id="undo-redo-toolbar",a.className="undo-redo-toolbar",a.appendChild(t),a.appendChild(n),t.addEventListener("click",function(){previousValue===""||previousValue===focusedInput.value||(nextValue=focusedInput.value,focusedInput.value=previousValue)}),n.addEventListener("click",function(){nextValue===""||nextValue===focusedInput.value||(previousValue=focusedInput.value,focusedInput.value=nextValue)}),a}function loadStyle(){var e=document.createElement("style");e.innerHTML=`
    .micro-ai-button {
        position: absolute;
        right: 3px;
        z-index: 10;

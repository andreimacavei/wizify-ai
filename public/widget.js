let BASE_URL="http://localhost:3000/api/enhance";function emToPixels(r,o){o=o||document.documentElement;var i=getComputedStyle(o).fontSize;i||(i=getComputedStyle(document.documentElement).fontSize);var e=parseFloat(i),a=r*e;return a}function copyStyles(r,o){const i=window.getComputedStyle(r);for(let e=0;e<i.length;e++){const a=i[e];a=="width"&&(o.style[a]=i.getPropertyValue(a))}o.style.width=r.offsetWidth+"px",o.style.height=r.offsetHeight+"px"}document.addEventListener("DOMContentLoaded",function(){var r=document.createElement("style");r.innerHTML=`
    .micro-ai {
        position: absolute;
        right: 3px;
        z-index: 10;

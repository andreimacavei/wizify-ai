let BASE_URL="https://app.wizzardai.dev/api/enhance",CLIENT_KEY=extractClientId(document.currentScript.getAttribute("src"))||"";function extractClientId(e){const o=/client_key=([^&]*)/,t=e.match(o);return t?t[1]:null}function emToPixels(e,o){o=o||document.documentElement;var t=getComputedStyle(o).fontSize;t||(t=getComputedStyle(document.documentElement).fontSize);var c=parseFloat(t),r=e*c;return r}function copyStyles(e,o){const t=window.getComputedStyle(e);for(let c=0;c<t.length;c++){const r=t[c];r=="width"&&(o.style[r]=t.getPropertyValue(r))}o.style.width=e.offsetWidth+"px",o.style.height=e.offsetHeight+"px"}function loadStyle(){var e=document.createElement("style");e.innerHTML=`
    .micro-ai-button {
        position: absolute;
        right: 3px;
        z-index: 10;

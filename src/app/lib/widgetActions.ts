...
export async function fetchWidgetOptionsByUserId(userId: string) {
  ...
  try {
    ...
    const result = {
      ...
      subscriptionUsedCredits: subscription?.usedCredits || null,
      subscriptionCredits: subscription?.credits || null,
      planName: plan?.name || null,
      planPrice: plan?.price || null,
      planDomainsAllowed: plan?.domainsAllowed || null,
  ...
  try {
    ...
    if (!widget) {
      return {
        ...
        widgetId: null,
        subscriptionId: null,
        subscriptionUsedCredits: null,
        subscriptionCredits:  null,
        planName: null,
        planPrice: null,
        planDomainsAllowed: null,
        planOptions: [],
        customOptions: [],
      };
    }

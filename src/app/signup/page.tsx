                          ...
                          <div className="mb-4 p-4 border border-red-500 text-red-500 rounded">
                            <ul>
                              {validationErrors.map((error, index) => (
                                <li key={index} style={{ color: 'red' }}>{error.path.join('.')} - {error.message}</li>
                              ))}
                            </ul>
                          </div>
                        )}
                        ...
                        <form onSubmit={handleSubmit}>
                          ...
                          <div className="flex justify-center mb-5">
                            <button 
                              ...
                              className="animate-fade-in rounded border border-orange  bg-orange px-6 py-2 text-sm text-white transition-all hover:bg-orange hover:text-white"
                            >
                              Sign Up
                            </button>
                          </div>
